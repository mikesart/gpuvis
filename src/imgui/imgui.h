...
namespace ImGui
{
    ...
    IMGUI_API const ImVec4  &GetColorVec4(ImGuiCol idx);                                        // retrieve given style color
    ...
    IMGUI_API bool          CheckboxInt(const char* label, int* v);
...
struct ImGuiIO
{
    ...
    ImVec2        MousePosInvalid;          // = -256000f,-256000f  // Mouse position when off window and mouse button not down
...
struct ImFont
{
    ...
    IMGUI_API void              RenderGlyph(ImDrawList* draw_list, ImVec2 pos, ImU32 col, const ImFont::Glyph* glyph) const;
